...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    Route::get('/kontaktai', 'Webkul\Shop\Http\Controllers\ContactController@index')->defaults('_config', [
    ...
    Route::get('/manoprofilis', 'Webkul\Shop\Http\Controllers\ContactController@index')->defaults('_config', [
        'view' => 'shop::home.profile'
    ])->name('shop.home.profile');

    Route::get('/apie-mus', 'Webkul\Shop\Http\Controllers\ContactController@index')->defaults('_config', [
        'view' => 'shop::home.about'
    ])->name('shop.home.about');

    Route::get('/privatumo-politika', 'Webkul\Shop\Http\Controllers\ContactController@index')->defaults('_config', [
    ...
    Route::get('/categories1', 'Webkul\API\Http\Controllers\Shop\CategoryController@getCategories');
    ...
    Route::any('/parduotuve', 'Webkul\Shop\Http\Controllers\SearchController@all')->defaults('_config', [
        'view' => 'shop::search.all'
    ])->name('shop.search.all');

    Route::any('/naujienos', 'Webkul\Shop\Http\Controllers\NewController@all')->defaults('_config', [
        'view' => 'shop::search.new-products'
    ])->name('shop.search.new-products');

    Route::any('/akcijos', 'Webkul\Shop\Http\Controllers\SaleController@all')->defaults('_config', [
        'view' => 'shop::search.sale-products'
    ])->name('shop.search.sale-products');
