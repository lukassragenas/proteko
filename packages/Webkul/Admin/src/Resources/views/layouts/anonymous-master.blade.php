...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        @endif
        {{-- <link rel="stylesheet" href="{{ asset('vendor/webkul/admin/assets/css/bliss.css') }}"> --}}
                ...
                <div class="adjacent-center">
                    ...
                    <div class="brand-logo">
                        @if (core()->getConfigData('general.design.admin_logo.logo_image', core()->getCurrentChannelCode()))
                            <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('general.design.admin_logo.logo_image', core()->getCurrentChannelCode())) }}" alt="{{ config('app.name') }}"/>
                        @else
